...
class ProfilesController extends Controller {
    ...
    public function getUserByUsername($username) {
        return User::with('profile', 'audio')->wherename($username)->firstOrFail();
    }
    ...
    public function update($username, Request $request) {
        ...
        $input = Input::only('dob', 'location', 'bio', 'telephone', 'avatar_status');
    ...
    public function upload() {
        if (Input::hasFile('file')) {
            ...
            Image::make($avatar)->fit(300, 300)->save($save_path . $filename);
    ...
    /**
     * Get User Restore Separation Key.
     *
     * @return string
     */
