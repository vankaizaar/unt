                ...
                if (document.getElementById('map-canvas')) {
                    ...
                    function getMap() {
                        ...
                        var marker = new google.maps.Marker({
                            map: map,
                            //icon: "",
                            title: '<strong>{{$user->first_name}} {{$user->last_name}}</strong> <br />  {{$user->email}} <br />  {{$user->profile->telephone}}',
                            position: map.getCenter()
                        });

                        // INFO WINDOW
                        var infowindow = new google.maps.InfoWindow();
                        infowindow.setContent('<strong>{{$user->first_name}} {{$user->last_name}}</strong> <br />  {{$user->email}} <br />  {{$user->profile->telephone}}');
